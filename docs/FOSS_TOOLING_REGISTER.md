...
|---|---|---|---|
| Worldbuilding data vocabulary | [`OnlyWorlds/OnlyWorlds@ed84fa19`](https://github.com/OnlyWorlds/OnlyWorlds/tree/ed84fa19c15c5bfb18019245faacdbdcb7cd9e0f) | [MIT](https://github.com/OnlyWorlds/OnlyWorlds/blob/ed84fa19c15c5bfb18019245faacdbdcb7cd9e0f/LICENSE) | **Adopted in part.** SERVATI's JSON profile derives from the base, Location, Event, Collective, Institution, Object, Narrative, Language, Species, and Relation schema vocabulary. The upstream `World` grouping collision is omitted; explicit Relation entities carry those links. |
...
| Link checking | [`lycheeverse/lychee-action@v2.9.0`](https://github.com/lycheeverse/lychee-action/tree/e7477775783ea5526144ba13e8db5eec57747ce8) with [`lychee@v0.24.2`](https://github.com/lycheeverse/lychee/releases/tag/lychee-v0.24.2) | [MIT](https://github.com/lycheeverse/lychee-action/blob/v2.9.0/LICENSE-MIT) or [Apache-2.0](https://github.com/lycheeverse/lychee-action/blob/v2.9.0/LICENSE-APACHE) | **Adopted in CI.** Action and engine versions are pinned; no binary or source is committed. |
| YAML parsing | [`yaml/pyyaml@6.0.3`](https://github.com/yaml/pyyaml/tree/49790e73684bebad1df05ef8d828fa12f685bffb) | [MIT](https://github.com/yaml/pyyaml/blob/49790e73684bebad1df05ef8d828fa12f685bffb/LICENSE) | **Adopted in CI** for the small SERVATI policy checker. |
| JSON Schema validation | [`python-jsonschema/jsonschema@v4.26.0`](https://github.com/python-jsonschema/jsonschema/tree/v4.26.0) (tag `c87a9220`) | [MIT](https://github.com/python-jsonschema/jsonschema/blob/v4.26.0/COPYING) | **Adopted in CI** as the pinned validation library used by `check-jsonschema`. |
| JSON Schema CLI | [`python-jsonschema/check-jsonschema@0.38.0`](https://github.com/python-jsonschema/check-jsonschema/tree/12e63946db2c5cfcc9030fac21c3883ba88c6ed8) | [Apache-2.0](https://github.com/python-jsonschema/check-jsonschema/blob/0.38.0/LICENSE) | **Adopted in CI** for the SERVATI dataset schema and GitHub workflow schema. |
| YAML linting | [`adrienverge/yamllint@v1.38.0`](https://github.com/adrienverge/yamllint/tree/cba56bcde1fdd01c1deb3f945e69764c291a6530) | [GPL-3.0](https://github.com/adrienverge/yamllint/blob/v1.38.0/LICENSE) | **Adopted as an external CI tool.** No GPL code is copied into SERVATI. |
| Repository checkout action | [`actions/checkout@v7.0.1`](https://github.com/actions/checkout/tree/3d3c42e5aac5ba805825da76410c181273ba90b1) | [MIT](https://github.com/actions/checkout/blob/v7.0.1/LICENSE) | **Adopted in CI**, pinned to the release commit with persisted credentials disabled. |
| Python setup action | [`actions/setup-python@v7.0.0`](https://github.com/actions/setup-python/tree/5fda3b95a4ea91299a34e894583c3862153e4b97) | [MIT](https://github.com/actions/setup-python/blob/v7.0.0/LICENSE) | **Adopted in CI**, pinned to the release commit. |
...
| YAML action wrapper | [`ibiqlik/action-yamllint@v3.1.1`](https://github.com/ibiqlik/action-yamllint/tree/2576378a8e339169678f9939646ee3ee325e845c) | [MIT](https://github.com/ibiqlik/action-yamllint/blob/v3.1.1/LICENSE) | Valid licence, but its latest release is from 2022 and repository activity stopped in 2023; the maintained upstream `yamllint` release is used directly instead. |
| Contemporary system-generation candidate | [`FrunkQ/star-system-generator@813eb19b`](https://github.com/FrunkQ/star-system-generator/tree/813eb19b0f1cab8be40b4cc5a737f993440c5c8e) | [GPL-3.0](https://github.com/FrunkQ/star-system-generator/blob/813eb19b0f1cab8be40b4cc5a737f993440c5c8e/LICENSE) | Actively developed and transparent about calculations, but targets “close enough” RPG plausibility rather than audited research output. Evaluated, not run or copied; candidate systems remain qualitative and require scientific review. |
| StarGen II system generation | [`Sphinkie/StarGen-II@6ad71da2`](https://github.com/Sphinkie/StarGen-II/tree/6ad71da251acb46f2623a0c700d1069faf15950a) | [MIT](https://github.com/Sphinkie/StarGen-II/blob/6ad71da251acb46f2623a0c700d1069faf15950a/LICENSE) | Evaluated, not adopted. It is a 2006 StarGen fork and the observed repository revision is from 2023; its output would still require modern scientific audit. |
