...
| Public linked-lore site | [`jackyzha0/quartz@f1fba3fc`](https://github.com/jackyzha0/quartz/tree/f1fba3fc55cbf60a60a5d09c95a49c042cdab63a) | [MIT](https://github.com/jackyzha0/quartz/blob/f1fba3fc55cbf60a60a5d09c95a49c042cdab63a/LICENSE.txt) | **Adopted for the Codex build.** Acquired at its exact commit and not vendored; see the Phase 2 register and build manifest. |
